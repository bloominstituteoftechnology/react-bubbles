...
- [ ] Explain what a token is used for.
      ...
      Tokens are used to track whether a person is logged in or not.

- [ ] What steps can you take in your web apps to keep your data secure?

      I can add protected routes in order to keep stuff safe and secure.

- [ ] Describe how web servers work.

      Code is stored on a computer. When something needs access to that code it sends a request to that computer to get the code.
