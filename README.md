...
- [ ] Explain what a token is used for.
      ...
      A token is used to identify a user logging into a network when the correct credentials are entered.

- [ ] What steps can you take in your web apps to keep your data secure?

      Using private routes,  having basic or no error messages in your code, keeping the app up to date, and making sure the backend/servers are running well.

- [ ] Describe how web servers work.

      A server uses HTTP to serve up the files/data from our web applications when they are requested by the user.
