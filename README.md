...
Tokens are used for making sure the user is authorized to view our app or sensitive data.

- [ ] What steps can you take in your web apps to keep your data secure?

We can implement protected routes that can only be used if you are authenticated through the token.
...
We can use get, post, put, delete methods.
