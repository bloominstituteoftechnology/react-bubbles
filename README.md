...
- [ ] Explain what a token is used for.
      •	Used to authenticate if a person has credentials to view webpages

- [ ] What steps can you take in your web apps to keep your data secure?
      1.	Login Page (using protected routes)
      2.	Enforce a strong password
      3.	Use a secure hosting server
      4.	Back up data

- [ ] Describe how web servers work.
      1.	Computer that stores code for a website
      a.	Stores
      b.	Processes 
      c.	Deliver web pages
      2.	Program that runs on the computer
      a.	Get the code 
      b.	Shows the code on request
