...
* [ ] What steps can you take in your web apps to keep your data secure?
      BACK UP DATA SCAN SITE OFTEN KEEP CODE UP TO DATE ADD WEB APP SECURITY

- [ ] Describe how web servers work.
      WEB SERVER PROCESS INCOMING NETWORK REQUESTS OVER HTTP AND SEVERAL OTHER RELATED PROTOCOLS, A SERVER STORES, PROCESS AND DELIVERS DATA TO WEB PAGES.
