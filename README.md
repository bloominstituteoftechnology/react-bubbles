...
---- Some steps you can take in your web apps to keep your data secure is to always use tokens to authenticate users, use protected routes, and to make sure your server is up to date. 
