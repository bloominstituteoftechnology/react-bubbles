...
- [x] Explain what a token is used for.
  ...
  Tokens are used primarily for authentication, during our topic. Though I inderstand the topic has a wider scope.

- [x] What steps can you take in your web apps to keep your data secure?

  have authentication, use https, run tests? Don't think we really covered this topic this module. Not sure what it alldues too?
...
- [x] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
  ...
  Create Put and/or Post requests
  Read - Get requests
  Update - Put requests
