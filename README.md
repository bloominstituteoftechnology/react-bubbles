...
A token is used to authenticate a server request.

- [ ] What steps can you take in your web apps to keep your data secure?

Steps to keep data in web apps secure are to avoid client-side authentication and use cookies securely. 

- [ ] Describe how web servers work.

Servers retrieve code and "serve" it to users upon request.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

The HTTP methods that can be mapped to CRUD are POST, GET, PUT, and DELETE.
