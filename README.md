...
- [ ] Explain what a token is used for.
  Tokens are used to provide proof that a user has been authenticated. For example: Applications can use a 'JSON Web Token' as proof that the user has access to certain parts of an app.

- [ ] What steps can you take in your web apps to keep your data secure?
 One can use protected routes that will not allow a user access to data without correct authentication.
...
Methods that one can use are: .post, .get, .put and .delete.
