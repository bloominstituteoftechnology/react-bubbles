...
- [ ] Explain what a token is used for.
  ...
  Tokens are used for user authentication within applications.

- [ ] What steps can you take in your web apps to keep your data secure?

  Web apps can be secured by creating private routes that require users to be signed in/ authenticated in order to access private data.
