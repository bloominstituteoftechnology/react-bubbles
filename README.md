...
a token is stored by the server and returned to user if credentials match the ones stored in the server, the token is then used by the user application to access data requiring the authorization
