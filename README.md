...
- [ ] Explain what a token is used for.
  ...
  Tokens are used to verify that you are who you say you are

- [ ] What steps can you take in your web apps to keep your data secure?

  Make suer you use authentication like usernames and passowrds
  Hash your passwords so you don't store them in cleartext

- [ ] Describe how web servers work.
  
  Web servers are a computer with an internet address that allow other computers (clients) to make request
  and they respond with data or execute functions.
