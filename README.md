...
- [ ] Explain what a token is used for.
      To provide proof that a user is authenticated. Applications can use a 'JSON Web Token' as proof that the user has access to certain parts of an application
- [ ] What steps can you take in your web apps to keep your data secure?
      We can use protected routes that will not allow a user access to data without the correct authentication
- [ ] Describe how web servers work.
      Usually a series of computers that store data and are connected to the internet which have software installed to 'serve' web pages that retrive the data based on a user's request
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
      The methods we use are .post, .get, .put and .delete.
