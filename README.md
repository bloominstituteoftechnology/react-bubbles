...
- [x] Explain what a token is used for.
  * Authenticating a user and allowing them access to secure parts of the site or data

- [x] What steps can you take in your web apps to keep your data secure?
  * Private routes, API calls with authorization requests, third party auth libraries

- [x] Describe how web servers work.
  * …broad question… Web servers work in coordination with other web servers to route and fulfill requests for code or programs sent from clients. 
