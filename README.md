...
- [x] Explain what a token is used for.
  ...
  A token is used to verify that the user has successfully been authenticated with the server and should be allowed to access private routes.

- [x] What steps can you take in your web apps to keep your data secure?

  Hide personal data behind private routes, control data fetching using auth tokens to prevent rendering of insecure data.

- [x] Describe how web servers work.

  Web servers host code for our applications that can then be served to users upon request.
